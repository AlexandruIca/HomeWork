...
int main()
{
	...
	outline_triangle( hw::vec2{ 50, 120 }, hw::vec2{ 20, 180 }, hw::vec2{ 70, 180 }, hw::color{ 234, 192, 45 });
	...
	OutlineTriangle b{ hw::vec2{ 220, 120 }, hw::vec2{ 190, 180 }, hw::vec2{ 230, 180 }, hw::color{ 90, 90, 20 } };
